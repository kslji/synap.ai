...
export const AGENT_PACKS: AgentPack[] = [
  {
    ...
    downloadHint: "Zip is small (~few MB). Pick a 1–8 GB RAM model below — that model downloads separately.",
  ...
  },
  {
    ...
    downloadHint: "Zip is small. Model download is about 1–3 GB for the light packs below.",
  ...
  },
  {
    ...
    downloadHint: "Zip is small. Model size follows the light pack you choose below (~1–3 GB).",
    opens: "Chrome → localhost chat",
  ...
  },
  {
    ...
    downloadHint: "Zip is small. Pick a 1–8 GB RAM model below for the separate model download.",
    opens: "Chrome → localhost chat",
