...
Unit evals (`test_guardrails.py`, `test_moss.py`) do **not** need a model. They fail the pipeline if Moss would return product README/seed copy, or if sanitizers miss injection/secrets.
