...
| `evals/test_pack_guardrails.py` | Pack ships guardrail evals + runtime sanitizer (injection/secrets) |
...
| `evals/test_diagram_overview.py` | Light-model diagram/summary early-exit + composer flex / Grammarly |
